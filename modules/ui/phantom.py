...
class PhWidget(QWidget):
    ...
    def locate_ph(self, loc):
        if loc == "home":
            ...
            self._ph_x_edit.setText("{:.1f}".format(79))
            self._ph_y_edit.setText("0")
            self._ph_r_edit.setText("0")
    ...
    def change_line_edit(self, axis):
        if axis == 0:
            try:
                self._x_slider.setValue(float(self._ph_x_edit.text()))
            except ValueError:
                pass
        elif axis == 1:
            try:
                self._y_slider.setValue(float(self._ph_y_edit.text()))
            except ValueError:
                pass
        else:
            try:
                self._r_slider.setValue(float(self._ph_r_edit.text()))
            except ValueError:
                pass
